...
summarizer_agent = AssistantAgent(
    ...
    system_message=(
        ...
        "**Summary**: {summary}\n"
        "\n"
        "Add extra spacing between papers for readability. Make the bullets visually appealing and easy to scan. Use bold for titles, monospace for URLs, and bold for authors/year/summary labels.\n\n"
        "## **Conclusion**\n"
